...
MEDIA_URL_1 = '/home_image/'
MEDIA_ROOT_1  = os.path.join(BASE_DIR, 'home_image')

MEDIA_URL_2 = '/rgb/'
MEDIA_ROOT_2  = os.path.join(BASE_DIR, 'rgb')

MEDIA_URL_3 = '/annotated/'
MEDIA_ROOT_3  = os.path.join(BASE_DIR, 'annotated')